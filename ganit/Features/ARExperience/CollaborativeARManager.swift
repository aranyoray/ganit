...
class CollaborativeARManager: NSObject, ObservableObject {
    ...
    func shareProblem(_ problem: SharedProblem) {
        ...
        do {
            ...
            SignalLogger.signalProviderStarted("CollaborativeAR", available: false) // Failed to share problem: \(error)")
        }
    }
    ...
    func sendAction(_ actionType: PeerAction.ActionType, value: Int? = nil) {
        ...
        do {
            ...
            SignalLogger.signalProviderStarted("CollaborativeAR", available: false) // Failed to send action: \(error)")
        }
    }
    ...
    func sendCollaborationData(_ data: Data) {
        ...
        do {
            ...
            SignalLogger.signalProviderStarted("CollaborativeAR", available: false) // Failed to send collaboration data: \(error)")
        }
    }
