...
struct AssessmentReport: Codable, Identifiable {
    ...
    var summaryText: String {
        ...
        return "We've noticed some patterns related to \(conditions) that may be worth discussing with a learning specialist. This is not a diagnosis — just something to explore further."
    }
}
...
extension ScreeningCondition {
    var displayName: String {
        switch self {
        case .dyscalculia:     return "number processing"
        case .adhd:            return "attention patterns"
        case .cognitiveDecline: return "cognitive processing"
        }
    }
}
